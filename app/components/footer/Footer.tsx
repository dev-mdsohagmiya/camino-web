  ...
  return (
    <footer className="bg-[#323232] text-white pt-[60px]">
      ...
      <div className="max-w-[1482px] mx-auto px-7 grid grid-cols-12 gap-[30px]">
        <div className="col-span-12 lg:col-span-6 flex gap-[30px] items-center justify-center lg:justify-start">
          <h2 className="text-[30px] md:text-[64px] font-semibold">
            Let&apos;s discuss
          </h2>
          <GoArrowUpRight className="text-[40px] md:text-[60px] border rounded-full p-[4px] md:p-[8px]" />
        </div>
      ...
      <div className="max-w-[1482px] mx-auto px-7 grid grid-cols-12 gap-[30px]">
        <div className="col-span-12 md:col-span-6 flex gap-[60px] justify-center md:justify-start">
          <div>
            <p className="text-white opacity-50 uppercase">LOCAL TIME</p>
            <h4 className="text-[22px] font-medium">2:14 PM</h4>
          </div>
          <div>
            <p className="text-white opacity-50 uppercase">WEATHER</p>
            <h4 className="text-[22px] font-medium">1300 London</h4>
          </div>
        </div>
        <div className="col-span-12 md:col-span-6 text-center md:text-start">
          <p className="text-white opacity-50 uppercase">Social</p>
          <div className="flex gap-[15px] md:gap-[30px]">
            <p className="text-[22px] font-medium">Instagram</p>
            <p className="text-[22px] font-medium">Facebook</p>
            <p className="text-[22px] font-medium">Instagram</p>
          </div>
        </div>
      </div>
